...
log_folder = 'drive/MyDrive/Shreya Data/Shreya NLP/Project/logs'
model_folder = 'drive/MyDrive/Shreya Data/Shreya NLP/Project/models'
outputs_folder = 'drive/MyDrive/Shreya Data/Shreya NLP/Project/outputs'
result_folder = 'drive/MyDrive/Shreya Data/Shreya NLP/Project/out/'
data_path = 'drive/MyDrive/Shreya Data/Shreya NLP/Project/reference/data/' #'../../data/'
board_path = 'drive/MyDrive/Shreya Data/Shreya NLP/Project/runs/'
...
def main(config):
  ...
  if config['full_cv']: 
    ...
    logger.info(f'Max Training Accuracy: {max_train_acc}')
    logger.info(f'Min Training Loss: {min_train_loss}')
    logger.info(f'Max Val Accuracy: {max_val_acc}')
    logger.info(f'Min Val Loss: {min_val_loss}')
    logger.info(f'Val BLEU Score: {max_val_bleu}')
